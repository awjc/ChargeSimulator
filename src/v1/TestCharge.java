...
// g.setColor(newColor);
// g.fillOval(centerPoint.width + (int)((x - TEST_CHARGE_DIAMETER *
// ChargeSimulator.chargeSize/2)*scaleFactor),
// centerPoint.height +(int)((y - TEST_CHARGE_DIAMETER *
// ChargeSimulator.chargeSize/2)*scaleFactor),
// (int)Math.ceil(TEST_CHARGE_DIAMETER*scaleFactor *
// ChargeSimulator.chargeSize), (int)Math.ceil(TEST_CHARGE_DIAMETER*scaleFactor
// * ChargeSimulator.chargeSize));
// // g.fillRect((int)(centerPoint.width + x*scaleFactor),
// (int)(centerPoint.height + y*scaleFactor), 5, 5);
// }
...
// public void update(List<Charge> posCharges, List<Charge> negCharges, double
// deltaT){
// // public void update(Charge[] posCharges, Charge[] negCharges, double
// deltaT){
// force.reset();
